...
end_date = "2016-03-30"
url = 'http://101.200.130.178:7000/baidusys/AccountDailyReport/'
#############################################
###### 策略炒股通
...
if __name__ == "__main__":
    try:
        ...
        set_auth(service)
        res=service.getRealTimeData({"realTimeRequestType":{"performanceData":["impression","click","cost","cpc","ctr","cpm","conversion"],"levelOfDetails":2,"startDate":start_date,"endDate": end_date,"unitOfTime":5,"reportType":2}})
