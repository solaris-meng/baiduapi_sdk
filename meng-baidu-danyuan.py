...
if __name__ == "__main__":
    try:
        ...
        set_auth(service)
        res=service.getRealTimeData({"realTimeRequestType":{"performanceData":["impression","click","cost","cpc","ctr","cpm","conversion"],"levelOfDetails":5,"startDate":start_date,"endDate": end_date,"unitOfTime":5,"reportType":11}})
