...
jihua_all = get_all_jihua()
print jihua_all

start_date = "2016-04-10"
filename = 'output/%s-%s.xls' % (account_name, start_date)
#jihua_id_list = [56366383, 56775408]
rv = get_word_for_jihua_xls(account_id, jihua_all, start_date, filename)
